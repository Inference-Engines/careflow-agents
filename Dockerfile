...
# ─────────────────────────────────────────────────────────────────────────────
# CareFlow AI — Single Container Dockerfile
#
# Architecture inside the container:
#   Port 8000 (internal) ← adk api_server  (CareFlow agents)
#   Port 8080 (Cloud Run) ← uvicorn server.py  (FastAPI proxy + React UI)
#
# Build:
#   docker build -t gcr.io/reference-yen-492413-h8/careflow-agents .
# Run locally:
#   docker run -p 8080:8080 \
#     -e GOOGLE_GENAI_USE_VERTEXAI=TRUE \
#     -e GOOGLE_CLOUD_PROJECT=reference-yen-492413-h8 \
#     -e GOOGLE_CLOUD_LOCATION=us-central1 \
#     -e GOOGLE_APPLICATION_CREDENTIALS=/run/secrets/gcp-creds \
#     gcr.io/reference-yen-492413-h8/careflow-agents
# ─────────────────────────────────────────────────────────────────────────────
